...
df <- read.dbf(here("data/raw/INEI/2014_64_RECH0.dbf"))
...
df2 <- read.dbf(here("data/raw/INEI/2014_64_RECH1.dbf")) %>% 
...
df3 <- read.dbf(here("data/raw/INEI/2014_64_RECH4.dbf")) %>% 
...
df4 <- read.dbf(here("data/raw/INEI/2014_65_RECH23.dbf")) %>% 
...
df7 <- read.dbf(here("data/raw/INEI/2014_414_CSALUD01.dbf"))
...
write.csv(df_merge, here("data/clean/2014_clean.csv"), row.names=FALSE) 
