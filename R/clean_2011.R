...
df <- read.dbf(here("data/raw/INEI/2011_64_RECH0.dbf"))
...
df2 <- read.dbf(here("data/raw/INEI/2011_64_RECH1.dbf")) %>% 
...
df3 <- read.dbf(here("data/raw/INEI/2011_64_RECH4.dbf")) %>% 
...
df4 <- read.dbf(here("data/raw/INEI/2011_65_RECH23.dbf")) %>% 
...
df6 <- read.dbf(here("data/raw/INEI/2011_73_REC84DV.dbf"))
...
df7 <- read.dbf(here("data/raw/INEI/2011_64_RECH9.dbf"))
...
write.csv(df_merge, here("data/clean/2011_clean.csv"), row.names=FALSE) 
